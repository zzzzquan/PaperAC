...
function generateHTML(filename, sentences) {
    ...
    for (const s of sentences) {
        if (s.type === 'body') {
            const charCount = [...s.text].length;
            const widthPct = totalBodyChars > 0 ? (charCount / totalBodyChars) * 100 : 0;
...
<head>
    ...
    <title>paperAC - AIGC检测报告</title>
    <style>
        body { font-family: "PingFang SC", "Microsoft YaHei", sans-serif; line-height: 1.8; color: #333; max-width: 800px; margin: 0 auto; padding: 40px 20px; background: #f9f9f9 url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' version='1.1' height='200px' width='300px'><text x='150' y='100' fill='%23000000' font-size='20' font-family='Arial' transform='rotate(-30 150 100)' text-anchor='middle' opacity='0.05'>https://www.paperac.com/</text></svg>"); }
        ...
        .header-logo { display: flex; align-items: center; gap: 8px; font-weight: bold; font-size: 1.2em; color: #1f2937; }
        ...
        .ring-value { font-size: 2.2em; font-weight: bold; line-height: 1; margin-bottom: 6px; }
...
<body>
    <div class="header">
        <div class="header-logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="180 170 680 680" width="32" height="32">
    ...
    <div class="header-title">AIGC检测 · 简洁报告单</div>
